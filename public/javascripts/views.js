...
var HermitViews = (function() {
  ...
  var PostView = Backbone.View.extend({
    ...
    render: function() {
      ...
      var titleEditTxt = '<textarea id="title-Edit"></textarea>';
      var contentEditTxt = '<textarea id="post-Edit"></textarea>';
...
var EditView = Backbone.View.extend({
  ...
  var CreatePostView = Backbone.View.extend({
    ...
    render: function() {
      ...
      this.$el.html(createpostViewContainer + '<br><div>' + 'Chrip Title' + '</div>' + postTitle + '</div><div>' + '<br><div>' + 'Chrip' + '</div>' + postBody + '</div><div>' + savePost + '</div>');
      return this;
    },
